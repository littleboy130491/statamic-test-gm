                        ...
                        <s:nav handle="nav_header">
                            <li class="group relative shrink-0">
                                @if (count($children) > 0)
                                    ...
                                    <ul
                                        class="invisible absolute left-1/2 z-30 mt-8 min-w-56 -translate-x-1/2 rounded-2xl border border-(--color-line)/20 bg-white p-3 opacity-0 transition-all duration-200 group-hover:visible group-hover:opacity-100">
